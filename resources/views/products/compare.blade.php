                        ...
                        @foreach($products as $product)
                            ...
                            <th class="p-4 font-normal align-top border-l border-slate-100 w-64 max-w-[280px]">
                                <div class="space-y-3 relative">
                                    ...
                                    {{-- THUMBNAIL --}}
                                    <div class="w-full h-28 bg-slate-50 border border-slate-200/80 rounded-xl flex items-center justify-center p-2 text-[#0B5CFF] overflow-hidden">
                                        {!! $product->renderThumbnail('max-h-full max-w-full object-contain', 'w-10 h-10') !!}
                                    </div>
